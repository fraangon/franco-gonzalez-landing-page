...
function ProjectsItems() {
  ...
  var itemsPosition = Object(framer__WEBPACK_IMPORTED_MODULE_6__["useTransform"])(position, [0, (widthLayer - 400) * 0.92], [100, 100 - lengthItems]);

  function getPositionOffset() {
    var max = (widthLayer - 400) * 0.92;
    var posPercent = position.get() / max;
    return 100 - position.get() / (widthLayer - 400) * 0.92 * lengthItems;
  }
  ...
  return __jsx("div", {
    ...
    onDrag: function onDrag() {
      var max = (widthLayer - 400) * 0.92;
      var posPercent = position.get() / max;
      setXOffset(100 - position.get() / (widthLayer - 400) * 0.92 * lengthItems);
    },
    __self: this,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=2.c4c4e486b954c4c8065d.hot-update.js.map